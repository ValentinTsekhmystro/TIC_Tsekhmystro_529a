...
if __name__ == "__main__":
    ...
    for sequence in original_sequences:
        ...
        r.write(f'Відносна надмірність коду: {len(CHECK_BITS)/CHUNK_LENGTH}\n')
        r.write('__________Кодування__________'+'\n')
        r.write(f'Закодовані дані: {encoded}\n')

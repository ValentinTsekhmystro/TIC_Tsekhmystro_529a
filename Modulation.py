...
def main(ask, psk, fsk1, fsk2):
    ...
    plot(x_spectrum, spectrum_sequence_psk, axis_x="Частота, Гц", axis_y="Амплітуда спектру", title="Спектр при фазовій модуляції")
    ...
    plot(x_spectrum, spectrum_sequence_fsk, axis_x="Частота, Гц", axis_y="Амплітуда спектру", title="Спектр при частотній модуляції модуляції")
    noise = create_noise(0, 1, 1000)
    ...
    plot(x, ask_demodulated_signal, axis_x="Час, c", axis_y="Амплітуда сигналу", title="Демодульований сигнал з амплітудною модуляцією")
    plot(x, sequence_demodulated, axis_x="Час, c", axis_y="Амплітуда сигналу", title="Демодульована послідовність з амплітудною модуляцією")
    psk_demodulated_signal, sequence_demodulated = psk_demodulation(psk, sequence_psk_noise)
    plot(x, psk_demodulated_signal, axis_x="Час, c", axis_y="Амплітуда сигналу", title="Демодульований сигнал з фазовою модуляцією")
    plot(x, sequence_demodulated, axis_x="Час, c", axis_y="Амплітуда сигналу", title="Демодульована послідовність з фазовою модуляцією")
    fsk_demodulated_signal1, fsk_demodulated_signal2, sequence_demodulated = fsk_demodulation(fsk1, fsk2, sequence_fsk_noise)
    plot(x, fsk_demodulated_signal1, axis_x="Час, c", axis_y="Амплітуда сигналу", title="Демодульований сигнал 1 з частотною модуляцією")
    plot(x, fsk_demodulated_signal2, axis_x="Час, c", axis_y="Амплітуда сигналу", title="Демодульований сигнал 2 з частотною модуляцією")
    plot(x, sequence_demodulated, axis_x="Час, c", axis_y="Амплітуда сигналу", title="Демодульована послідовність з частотною модуляцією")
